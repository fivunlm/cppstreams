...
//
#ifndef CPPSTREAMS_INCLUDE_GUARD_CPPSTREAMS_VERSION_CHECK_H
#define CPPSTREAMS_INCLUDE_GUARD_CPPSTREAMS_VERSION_CHECK_H
...
#endif  // #ifndef CPPSTREAMS_INCLUDE_GUARD_CPPSTREAMS_VERSION_CHECK_H
